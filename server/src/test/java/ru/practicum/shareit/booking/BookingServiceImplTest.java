...
class BookingServiceImplTest {
    ...
    void postBooking() {
        ...
        Booking testBooking = bookingService.postBooking(booking1, 3L, 1);
    ...
    void postBookingWrongItem() {
        ...
        final ValidationException exception = Assertions.assertThrows(
                ...
                () -> bookingService.postBooking(booking1, 3L, 1));
    ...
    void patchBooking() {
        ...
        Booking testBooking = bookingService.patchBooking(1L, 1L, true);
        assertNotNull(testBooking);
        assertEquals(1L, testBooking.getId());
    ...
    void getBooking() {
        ...
        Booking testBooking = bookingService.getBooking(2L, 2L);
        assertNotNull(testBooking);
        assertEquals(2L, testBooking.getId());
        assertEquals(2020, testBooking.getStart().getYear());
    ...
    void getAllForBooker() {
        ...
        List<Booking> testList = bookingService.getAllForBooker("All", 1, 2, 1L);
    ...
    void getAllForBookerSetPast() {
        ...
        List<Booking> testList = bookingService.getAllForBooker("PAST", 0, 2, 1L);
        assertNotNull(testList);
    }
    ...
    void getAllForBookerSetFuture() {
        ...
        List<Booking> testList = bookingService.getAllForBooker("FUTURE", 0, 2, 1L);
        assertNotNull(testList);
    }
    ...
    void getAllForBookerSetCurrent() {
        ...
        List<Booking> testList = bookingService.getAllForBooker("CURRENT", 0, 2, 1L);
        assertNotNull(testList);
    }
    ...
    void getAllForBookerNullStateFirst() {
        ...
        List<Booking> testList = bookingService.getAllForBooker(null, 0, 2, 1L);
        assertNotNull(testList);
    }
    ...
    void getAllForNoBooker() {
        ...
        final NotFoundException exception = Assertions.assertThrows(
                ...
                () -> bookingService.getAllForBooker("All", 1, 2, 1L));
    ...
    void getAllForBookerWaiting() {
        ...
        List<Booking> testList = bookingService.getAllForBooker("WAITING", 0, 2, 1L);
        assertNotNull(testList);
    }
    ...
    void getAllForBookerRejected() {
        ...
        List<Booking> testList = bookingService.getAllForBooker("REJECTED", 0, 2, 1L);
        assertNotNull(testList);
    }
    ...
    void getAllForOwner() {
        ...
        List<Booking> testList = bookingService.getAllForOwner("All", 1, 2, 1L);
        assertNotNull(testList);
    }
    ...
    void getAllForNoOwner() {
        ...
        final NotFoundException exception = Assertions.assertThrows(
                NotFoundException.class,
                () -> bookingService.getAllForOwner("All", 1, 2, 1L));
        Assertions.assertEquals("Юзера с таким id 1 не существует", exception.getMessage());
    }
    ...
    void getAllForOwnerWaiting() {
        ...
        List<Booking> testList = bookingService.getAllForOwner("WAITING", 1, 2, 1L);
        assertNotNull(testList);
    }
    ...
    void getAllForOwnerRejected() {
        ...
        List<Booking> testList = bookingService.getAllForOwner("REJECTED", 1, 2, 1L);
        assertNotNull(testList);
    }
    ...
    void postBookingWithNoItem() {
        ...
        final NotFoundException exception = Assertions.assertThrows(
                NotFoundException.class,
                () -> bookingService.postBooking(booking1, 1L, 33));
    ...
    void postBookingWithNoUser() {
        ...
        final NotFoundException exception = Assertions.assertThrows(
                NotFoundException.class,
                () -> bookingService.postBooking(booking1, 33L, 1));
    ...
    void postBookingFromOwner() {
        ...
        final NullPointerException exception = Assertions.assertThrows(
                ...
                () -> bookingService.postBooking(newBooking, 1L, 1));
    }
    ...
    void postBookingFromPast() {
        ...
        final ValidationException exception = Assertions.assertThrows(
                ValidationException.class,
                () -> bookingService.postBooking(pastBooking, 1L, 3L));
    ...
    void getAllForBookerWithWrongState() {
        ...
        final ValidationException exception = Assertions.assertThrows(
                ValidationException.class,
                () -> bookingService.getAllForBooker("unknownState", 0, 2, 1L));
...
//    }
    ...
    void getAllForOwnerWithWrongState() {
        ...
        final ValidationException exception = Assertions.assertThrows(
                ValidationException.class,
                () -> bookingService.getAllForOwner("unknownState", 0, 2, 1L));
        Assertions.assertEquals("Unknown state: UNSUPPORTED_STATUS", exception.getMessage());
    }
...
//    }
    ...
    void patchBookingNoAccess() {
        ...
        final NotFoundException exception = Assertions.assertThrows(
                NotFoundException.class,
                () -> bookingService.patchBooking(1L, 100L, true));
    ...
    void patchApprovedBooking() {
        ...
        final ValidationException exception = Assertions.assertThrows(
                ValidationException.class,
                () -> bookingService.patchBooking(2L, 2L, true));
