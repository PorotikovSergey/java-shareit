...
class RequestServiceImplTest {
    ...
    void postRequest() {
        ...
        Request testRequest = requestService.postRequest(request2, 2L);
    ...
    void getAll() {
        ...
        List<Request> testList = requestService.getAll(1L);
    ...
    void getAllPageable() {
        ...
        List<Request> resultList = requestService.getAllPageable(1, 10, 1L);
...
//    }
    ...
    void getRequest() {
        ...
        Request testRequest = requestService.getRequest("1", 1L);
        assertNotNull(testRequest);
        assertEquals(2L, testRequest.getId());
        assertEquals("description-2", testRequest.getDescription());
        assertEquals(request2.getCreated(), testRequest.getCreated());
    ...
    void getRequestWrongUser() {
        ...
        final NotFoundException exception = Assertions.assertThrows(
                ...
                () -> requestService.getRequest("1", 1L));
    ...
    void postRequestWrongDescription() {
        ...
        final ValidationException exception = Assertions.assertThrows(
                ...
                () -> requestService.postRequest(request2, 2L));
